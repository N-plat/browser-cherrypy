...
class Followers(object):
    ...
    def index(self):
        ...
        curs.execute("select follower from follows where followed=\""+cherrypy.session.get('_cp_username')+"\"");
        ...
        for follow in follows_fetchall:
            ...
            body_string += "<a href=/"+follow_dict["follower"]+">"+follow_dict["follower"]+"</a><br>\n" 
